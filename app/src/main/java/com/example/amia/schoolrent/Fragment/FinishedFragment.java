...
public class FinishedFragment extends Fragment implements MineRentContract.View {
    ...
    public static FinishedFragment newInstance(){
        FinishedFragment agreeFragement=new FinishedFragment();
