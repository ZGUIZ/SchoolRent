...
import com.example.amia.schoolrent.Fragment.RecyclerAdapter.MyAgreeAdapter;
...
public class MineAgreeFragement extends Fragment implements MineRentContract.View{
    ...
    public static MineAgreeFragement newInstance(){
        MineAgreeFragement agreeFragement=new MineAgreeFragement();
        return agreeFragement;
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.agreed_rent_layout,container,false);
        return view;
    }
    ...
    private void init(){
        ...
        adapter = new MyAgreeAdapter(getContext(), new MyAgreeAdapter.ResponseRentInterface() {
            @Override
