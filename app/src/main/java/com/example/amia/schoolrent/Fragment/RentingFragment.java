...
public class RentingFragment extends Fragment implements MineRentContract.View {
    ...
    public static RentingFragment newInstance(){
        RentingFragment agreeFragement=new RentingFragment();
    ...
    private void init(){
        ...
        adapter = new RentingAdapter(getContext(), new RentingAdapter.ResponseRentInterface() {
            @Override
