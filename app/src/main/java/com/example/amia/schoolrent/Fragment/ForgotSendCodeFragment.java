...
import static com.example.amia.schoolrent.Task.SchoolTask.ERROR;

public class ForgotSendCodeFragment extends Fragment implements ForgotPassContract.View {
    ...
    public static ForgotSendCodeFragment newInstance(){
        ForgotSendCodeFragment forgotSendCodeFragment=new ForgotSendCodeFragment();
        return forgotSendCodeFragment;
    }
    ...
    protected void init(){
        ...
        String mail = ((ForgotPassInterface)getActivity()).getMail();
    ...
    protected void sendMail(){
        ...
        presenter.sendMail(address,handler);
        email = address;
    }
    ...
    protected void sendValidate(){
        ...
        presenter.validateCode(keyValue,handler);
    }
     ...
     * 验证成功
     */
    protected void validateSuccess(Object o){
        try {
            ForgotPassInterface passInterface = (ForgotPassInterface) getActivity();
            passInterface.codeValidateSuccess((PassWord) o);
        } catch (Exception e){
            e.printStackTrace();
            linkError();
        }
