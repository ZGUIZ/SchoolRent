...
public class MyRequestAdapter extends RecyclerView.Adapter<MyRequestAdapter.RecViewholder> {
    ...
    public MyRequestAdapter(Context context, ResponseRentInterface responseRentInterface) {
    ...
    public RecViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.my_request_item, parent, false);
